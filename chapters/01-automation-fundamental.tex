...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Model: gpt-4o
        \item \newline
        Prompt: "Classify the following email into one of these categories: Urgent client issue, Project update, New business inquiry, Invoicing and payment, Administrative task. Email content: \{\{\$json["body"]\}\}"
        \item
    \end{itemize}
\end{enumerate}
